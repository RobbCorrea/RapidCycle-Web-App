...
import "../../scss/HowRCWorks.scss";

export default function HowRCWorks() {
  return <h1>Cómo funciona tu RC Web App.</h1>;
}

/* return (
    <Row className="how-my-courses-work">
      <Col lg={24} className="how-my-courses-work__title">
        <h2>¿Cómo funciona tu Rapid Cycle Webb App?</h2>
        <h3>
          Esta plataforma personalizada para tu negocio te permite gestionar a
          tu personal y sus privilegios de publicación de precios de compra y
